...
const ProfessionalConfirm = ({isVisible , close}) => {
  return(
    <>
      <Modal isOpen={isVisible} onRequestClose={close} style={{
        content: {
          width: "600px",
          height: "550px",
          margin: "0 auto",
        ...
        <StyledDiv style={{margin: "0 auto",textAlign: "center", marginTop: "61px",}} >
          <Button style={buttonStyleCancel}>Cancel</Button>
          <Button style={buttonStyleProceed}  type="primary">Proceed to Payment</Button>
        </StyledDiv>
      </Modal>
    </>
  );
...
const ShareModal = ({isVisible, close}) => {
  return(
    <ShareModalStyle isOpen={isVisible} onRequestClose={close}>
      <StyledDiv>
        <Button style={closeModalButton}><CloseOutlined /></Button>
      </StyledDiv>
      <StyledDiv textCenter marginTop>
        Share
      </StyledDiv>
      <StyledDiv style={{display: "inline-flex", flexWrap: "wrap", width: "100%"}} marginTop>
        <Button style={circleButton} type="primary">fb</Button>
        <Button style={circleButton} type="primary">t</Button>
        <Button style={circleButton} type="primary">G</Button>
        <Button style={circleButton} type="primary">L</Button>
      </StyledDiv>
      <StyledDiv textCenter marginTop>
        Share event link
      </StyledDiv>
      <StyledDiv>
        <Search bGray  enterButton={<FileOutlined />} 
