...
const makeSelectAccounts = () =>
  createSelector(selectAccountsDomain, (substate) => substate);

const makeSelectAccount = () =>
  createSelector(selectAccountsDomain, (substate) => substate.zoomAccount);

const makeSelectAccountList = () =>
  createSelector(selectAccountsDomain, (substate) => substate.zoomAccountList);
